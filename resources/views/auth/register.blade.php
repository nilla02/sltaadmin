                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div>
                                ...
                                <div>
                                    <input id="{{$role->slug}}" type="checkbox" class="form-control2 @error('{{$role->slug}}') is-invalid @enderror" name="{{$role->name}}" value="{{$role->id}}" autofocus>
                                    <label for="{{$role->slug}}">{{ __($role->slug) }}</label>
                                </div>
